                                ...
                                <div class="box-body no-padding">
                                    <div class="mailbox-controls">
                                        ...
                                        <div class="pull-right">
                                            <?php $counted = count(App\Model\Tickets\Tickets::where('status','=',1)->get()); echo "5/".$counted; ?>
                                            </div>
                                    </div>
                                    <div class=" table-responsive mailbox-messages"  id="refresh">
                                        <table class="table table-hover table-striped">
                                            ...
                                            <tbody id="hello">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="mailbox-name"><a href="{!! route('user.thread',[$ticket->id]) !!}">{{$title->title}}</a></td>
                                        ...
                                        <div class="pull-right">
                                        <?php
                                        echo $tickets->setPath( url('/ticket'))->render(); ?>&nbsp;
                                        </div>
                                    </div>
                                </div>
                            </div>
