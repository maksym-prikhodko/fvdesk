@extends('themes.default1.layout')
                ...
                <section class="content">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title"><i class="fa fa-user"> </i> {{$thread->user_id}} </h3> ( organisation )
                            <div class="pull-right">
                                <button type="button" class="btn btn-default"><i class="fa fa-edit" style="color:green;"> </i> {!! link_to_route('ticket.edit','Edit',[$tickets->id]) !!}</button>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        ...
                                        <li><a href="#"><i class="fa fa-trash-o" style="color:red;"> </i>Delete Ticket</a></li>
