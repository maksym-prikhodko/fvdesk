...
class ConfigurationTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals($this->config->getNotifyEndpoint(), "https:
    }
    public function testNonSSLEndpoint()
    {
        $this->config->useSSL = false;
        $this->assertEquals($this->config->getNotifyEndpoint(), "http:
    }
    ...
    public function testNotifier()
    {
        ...
        $this->assertEquals($this->config->notifier['url'], "https:
    }
}
