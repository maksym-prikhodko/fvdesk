...
class PhoneNumberUtilTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIsLeadingZeroPossible()
    {
        ...
        $this->assertTrue($this->phoneUtil->isLeadingZeroPossible(800)); 
        $this->assertFalse($this->phoneUtil->isLeadingZeroPossible(979)); 
        $this->assertFalse(
    ...
    {
        $inputNumber = "\xEF\xBC\x92" . "5\xD9\xA5" 
        ;
        $expectedOutput = "255";
        $this->assertEquals(
            $expectedOutput,
