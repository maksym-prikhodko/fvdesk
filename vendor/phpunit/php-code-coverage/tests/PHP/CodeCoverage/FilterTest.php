...
class PHP_CodeCoverage_FilterTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertFalse($this->filter->isFile('vfs:
        $this->assertFalse($this->filter->isFile('xdebug:
    ...
    {
        $this->assertTrue($this->filter->isFiltered('vfs:
        $this->assertTrue($this->filter->isFiltered('xdebug:
