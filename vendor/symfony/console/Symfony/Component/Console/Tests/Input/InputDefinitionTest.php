...
class InputDefinitionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLegacyAsText()
    {
        ...
        $definition = new InputDefinition(array(
            ...
            new InputArgument('bar', InputArgument::OPTIONAL | InputArgument::IS_ARRAY, 'The bar argument', array('http:
            ...
            new InputOption('qux', '', InputOption::VALUE_OPTIONAL | InputOption::VALUE_IS_ARRAY, 'The qux option', array('http:
